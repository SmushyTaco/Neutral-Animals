...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(486981, jar)
        file.displayName = "[${libs.versions.minecraft.get()}] Neutral Animals"
...
modrinth {
    ...
    projectId = "neutral-animals"
    uploadFile.set(tasks.jar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] Neutral Animals" }
    dependencies {
